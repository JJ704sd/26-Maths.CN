...
[论文 PDF](papers/2026-C-v7/main.pdf) · [LaTeX 源码](papers/2026-C-v7/main.tex) · [完整工作包](papers/2026-C-v7/论文第七版完整工作包.zip) · [修订与复现说明](papers/2026-C-v7/复现与修订说明.md)

本版补充周期库存及退订不退款的重优化对照，工作包包含五份主结果 Excel、输入数据、代码与校验记录。主结果采用退款结算假设；其他解释的适用范围见修订说明。本次按用户授权发布该交付目录，本地其他材料仍不纳入同步。
